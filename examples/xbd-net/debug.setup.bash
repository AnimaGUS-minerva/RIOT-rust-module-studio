...
alias nns='echo "assuming tap1 is already set up" && IPV6_AUTO=0 IPV6_ADDR=fe80::78ec:5fff:febd:add9 GCOAP_ENABLE_DTLS=1  make build-native && EMU_NATIVE_TAP=tap1  make native-run-riot'
